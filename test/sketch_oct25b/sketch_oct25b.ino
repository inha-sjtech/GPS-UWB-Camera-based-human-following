...
ros::Publisher floatter2("floatter2", &float32_msg);
float message = 0.0;
bool flag = false;
...
void setup() {
  ...
  DW1000Ranging.startAsAnchor("82:17:5B:D5:A9:9A:E2:9D", DW1000.MODE_LONGDATA_RANGE_LOWPOWER);
}
